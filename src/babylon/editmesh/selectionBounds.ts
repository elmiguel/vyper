...
/** Axis-aligned bounds of a set of kernel vertices, used by the Inspector to show and edit a
 *  selection's position (centroid) and dimensions (size) in Edit Mode. Relocated from the
 *  retired Modeling Studio so the unified editor no longer depends on `src/modeler`. */

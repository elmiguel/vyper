...
// Box/tri-planar UVs now live in the kernel (shared with buildCustomMesh); re-exported here for
// the modeler modules that import it from this path.
export { computeBoxUVs } from '@/kernel/render';
